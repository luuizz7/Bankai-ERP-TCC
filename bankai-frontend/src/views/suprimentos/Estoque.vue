  ...
  <div class="page-container">
    <header class="page-header">
      <div>
        ...
        <p class="text-secondary">Gerencie o estoque dos seus produtos.</p>
      </div>
    </header>

    <div class="card">
      <div class="card-header">
        <input type="text" v-model="filtro" placeholder="Pesquisar por produto ou SKU..." class="search-input" />
      </div>
      <div class="card-body">
        <table class="table">
          <thead>
            <tr>
              <th>Produto</th><th>SKU</th><th>Estoque Físico</th>
            </tr>
          </thead>
          <tbody>
